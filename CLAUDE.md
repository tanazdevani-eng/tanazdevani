...
- **Typography**: display/headline face is **Fraunces** (serif, upright/non-italic throughout — the wordmark, habit names, and quoted notes all use it upright, giving editorial warmth without the slant). Body/UI text is **Inter**. Data/numeric/label text (streak counts, timestamps, mono-style tags) uses **IBM Plex Mono**.
